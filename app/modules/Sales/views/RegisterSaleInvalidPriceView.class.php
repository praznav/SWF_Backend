...
class Sales_RegisterSaleInvalidPriceView extends ShoppingwithfriendsSalesBaseView
{
    ...
    public function executeXml(AgaviRequestDataHolder $rd)
    {
        ...
        $message = $xml->createElement("message", "The price you have entered for your sale is invalid.");
